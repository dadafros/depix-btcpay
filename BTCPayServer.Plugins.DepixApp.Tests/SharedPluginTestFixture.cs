...
public sealed class SharedPluginTestFixture : IDisposable
{
    ...
    private const string PluginProjectFile = "BTCPayServer.Plugins.DepixApp/BTCPayServer.Plugins.DepixApp.csproj";
    private const string PluginAssemblyName = "BTCPayServer.Plugins.DepixApp.dll";
